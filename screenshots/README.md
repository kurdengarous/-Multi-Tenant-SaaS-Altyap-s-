...
Bu klasör, uygulamanın demo ekran görüntülerini içermektedir.

| Dosya | Sayfa |
|---|---|
| `01-ajans-secimi.png` | Ajans (tenant) seçim ekranı — `/` |
| `02-giris.png` | Giriş ekranı — `/login` |
| `03-panel.png` | Dashboard paneli — `/dashboard` |
